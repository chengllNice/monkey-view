<template>
    <div class="ButtonView">
        <div>
            ...
            default:<ClButton type="info">你好</ClButton>
            large:<ClButton type="info" size="large">你好</ClButton>
            ...
            disabled：<ClButton disabled>你好</ClButton>
            ...
            disabled：<ClButton type="primary" disabled>你好</ClButton>
            ...
            disabled：<ClButton type="danger" disabled>你好</ClButton>
            ...
            disabled：<ClButton type="warning" disabled>你好</ClButton>
            ...
            disabled：<ClButton type="success" disabled>你好</ClButton>
            ...
            disabled：<ClButton type="info" disabled>你好</ClButton>
            ...
            disabled：<ClButton type="text" disabled>你好</ClButton>
            ...
            disabled：<ClButton type="primary" block disabled>你好</ClButton>
            ...
            disabled：<ClButton type="primary" circle disabled>你好</ClButton>
        ...
        <div class="viewDes">
            ...
            <div class="propItem">
                <p><b>属性：type</b></p>
                <p><b>类型：String</b></p>
                <p><b>说明：</b>可选值primary/success/warning/danger/info/default</p>
                <p><b>默认值：</b>default</p>
            </div>
            <div class="propItem">
                <p><b>属性：disabled</b></p>
            ...
            <div class="propItem">
                <p><b>属性：size</b></p>
                <p><b>类型：String</b></p>
                <p><b>说明：</b>可选值mini/small/default/large</p>
                <p><b>默认值：</b>default</p>
            </div>
        </div>
...
<script>
  ...
  import ClButtonGroup from 'cl-ui/packages/components/button/src/button-group.vue'
  export default {
    name: "ButtonView",
    data() {
      return {}
