<template>
    <div class="ModalView">
        ...
        <div class="views-dev">
            ...
            <p>通过一下方式调用：</p>
            <ul>
                <li>this.$Modal.info(config)</li>
                <li>this.$Modal.success(config)</li>
                <li>this.$Modal.warning(config)</li>
                <li>this.$Modal.error(config)</li>
                <li>this.$Modal.confirm(config)</li>
            </ul>
