...
export default {
    ...
    methods: {
        ...
        setCurrentValue(data){
            ...
            this.currentValue = this.getPropFromCurrentDataByPath(this.currentData, data, 'value');
        ...
        setCurrentLabel(data){
            if(!this.changeOnSelect && data.__more) return;
            this.currentLabel = this.getPropFromCurrentDataByPath(this.currentData, data, 'label');
            ...
            if(itemData.length){
                for (let i = 0; i < itemData.length; i++){
                    if(itemData[i].value === values[i]){
                        this.setCurrentData(this.currentData, '__visible', itemData[i], true);
                        this.setCurrentData(this.currentData, '__selected', itemData[i], true);
