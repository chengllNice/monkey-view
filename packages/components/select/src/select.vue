            ...
            <DropDown v-show="visible && !disabled"
                ...
                <div class="cl-select__drop-down-inner" :style="{'height': dropDownHeight}">
                    <ClScroll size="small" :scrollOption="{scrollPanel:{scrollingX:false}}">
                        ...
                        <div ref="optionList" v-else-if="selectOptionsData&&selectOptionsData.length&&isOptionGroup&&!isSlotOption" class="cl-select__option-list">
                        ...
                        <div v-if="!loading && isEmpty" ref="optionList" class="cl-select__empty">{{localEmptyText}}</div>
                    </ClScroll>
                </div>
            </DropDown>
        </transition>
